...
const Slider: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <button
        className={`mt-2 flex justify-center gap-4 items-center font-semibold py-2 rounded-full w-full text-center text-sm border-2 ${theme === 'dark' ? 'bg-gray_l text-white border-zinc-700' : 'bg-white border-zinc-300 text-black'}`}
      >
        <IoMdAdd size={15} />
        Add Slice
      </button>
